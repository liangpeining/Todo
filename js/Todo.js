...
function renderList() {
    ...
    dataList.forEach(function(item,index){
        ...
        if (item.type == "todo") {
            newdiv.innerHTML = `
            <span class="checkbox">
            <input class="checkbox" type="checkbox" name="check" value="" data-index="${index}">
            </span>
            ...
            newdiv.innerHTML = `
            <span class="checkbox">
            <input class="checkbox" type="checkbox" name="check" checked = "checked" value="" data-index="${index}">
            </span>
            <span class="content">${item.content}</span>
            <span class="delete" data-index="${index}"></span>
            `;
...
// 监听事件
// 直接监听body上发生的点击事件，因为也是冒泡事件，所以直接监听body的div发生的事件
